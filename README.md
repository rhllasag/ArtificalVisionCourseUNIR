...
**Author:** PhD. Raúl Llasag Rosero  
**Email:** [raulhomero.llasag-externo@unir.net](mailto:raulhomero.llasag-externo@unir.net)  
**GitHub:** [@rhllasag](https://github.com/rhllasag)  
**ECTS Credits:** 6  
...
- ✅ Work with computational vision models and understand their applications
- ✅ Apply techniques for image pre-processing, segmentation, and feature extraction
- ✅ Develop systems for voice, image, and object recognition
- ✅ Evaluate performance metrics in computational perception systems
- ✅ Implement practical solutions using modern computer vision libraries
...
- **🧪 Lab 1:** Image enhancement using elementary operations (5.0 pts)
...
- **📝 Activity 2:** Spatial and morphological filters in real scenarios (3.5 pts)
- **📝 Activity 3:** Amazon deforestation analysis with segmentation (5.0 pts)
